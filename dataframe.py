...
class dataframe:
    ...
    def convert(self):
        ...
        bool_date1 = np.array([ self.date_today > y for y in date1])
        bool_date2 = np.array([ self.date_today > y for y in date2])
        bool_date3 = np.array([ self.date_today > y for y in date3])
